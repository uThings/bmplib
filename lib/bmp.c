...
BITMAP ReadBitmap (FILE *fp)
{
   ...
   printf ("fileheader.ImageFileType = %Xh\n", fileheader.ImageFileType);
   printf ("fileheader.FileSize = %d\n", fileheader.FileSize);
   printf ("fileheader.Reserved1 = %Xh\n", fileheader.Reserved1);
   printf ("fileheader.Reserved2 = %Xh\n", fileheader.Reserved2);
   printf ("fileheader.ImageDataOffset = %Xh\n", fileheader.ImageDataOffset);

   printf ("bmpheader.HeaderSize = %d\n", bmpheader.HeaderSize);
   printf ("bmpheader.ImageWidth = %d\n", bmpheader.ImageWidth);
   printf ("bmpheader.ImageHeight = %d\n", bmpheader.ImageHeight);
   printf ("bmpheader.NumberOfImagePlanes = %d\n",
           bmpheader.NumberOfImagePlanes);
   printf ("bmpheader.BitsPerPixel = %d\n", bmpheader.BitsPerPixel);
   printf ("bmpheader.CompressionMethod = %d\n",
           bmpheader.CompressionMethod);
   printf ("bmpheader.SizeOfBitmap = %d\n", bmpheader.SizeOfBitmap);
   printf ("bmpheader.HorizonalResolution = %d\n",
           bmpheader.HorizonalResolution);
   printf ("bmpheader.VerticalResolution = %d\n",
           bmpheader.VerticalResolution);
   printf ("bmpheader.NumberOfColorsUsed = %d\n",
           bmpheader.NumberOfColorsUsed);
   printf ("bmpheader.NumberOfSignificantColors = %d\n",
